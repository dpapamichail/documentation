...
.. important::
   The SRTP media encryption and TLS SIP transport are disabled by default in DIDWW. 
   Please contact the DIDWW sales team sales@didww.com to allow traffic encryption for your account.
...
Lastly, verify that your DID number is selected in the *Inbound Calls* section of the SIP Device Route settings.
