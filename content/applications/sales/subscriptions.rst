...
.. important::
   When creating a subscription for a physical good, selecting the "Delivered quantities"
   :guilabel:`Invoicing Policy` will lead to errors when invoicing a subscription order. Physical
   products must use the "Ordered quantities" :guilabel:`Invoicing Policy`.
